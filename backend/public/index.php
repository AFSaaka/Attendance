...
// ✅ FIX: Added X-CSRF-Token so browser CORS preflight allows it through
...
// ✅ FIX: Removed session_start() from here.
// common_auth.php handles session startup with the correct
// production settings (SameSite=None, Secure=true for cross-origin).
// Having two session_start() calls caused config conflicts.
...
$routes = [
    ...
    'admin/export/start-export'              => '../api/admin/export/start-export.php',
    'admin/export/process-export-chunk'            => '../api/admin/export/process-export-chunk.php',
    'admin/export/download-export'                => '../api/admin/export/download-export.php',
    'admin/get-communities'                  => '../api/admin/get-communities.php',
    'admin/get-attendance-detail'            => '../api/admin/get-attendance-detail.php',
    'admin/get-attendance-summary'           => '../api/admin/get-attendance-summary.php',
    'admin/get-student-attendance-history'   => '../api/admin/get-student-attendance-history.php',
    ...
    'admin/set-active-session'               => '../api/admin/set-active-session.php',
    ...
    'student/take_attendance'                => '../api/student/take_attendance.php',
    'student/verify-location'                => '../api/student/verify-location.php',
];
